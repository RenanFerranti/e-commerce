      ...
      >
        ...
        >
          ...
          <div style={{ borderTop: "1px solid #eee", paddingTop: "20px" }}>
            ...
            <p style={{ color: "#666" }}>
              O campeão nacional evoluiu. O novo Fila Corre 4 chega com a
              tecnologia de amortecimento otimizada para garantir ainda mais
              retorno de energia e uma transição de passada mais fluida. Seu
              cabedal em engineered mesh oferece ventilação máxima, mantendo os
              pés secos e confortáveis do primeiro ao último quilômetro.
            </p>
          </div>
