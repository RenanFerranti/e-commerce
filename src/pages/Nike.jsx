      ...
      >
        ...
        >
          ...
          <div style={{ borderTop: "1px solid #eee", paddingTop: "20px" }}>
            ...
            <p style={{ color: "#666" }}>
              Sinta a sensação de caminhar nas nuvens. Equipado com a tecnologia
              de amortecimento Air, este tênis oferece absorção de impacto de
              elite e uma resposta rápida a cada passo. O cabedal leve e
              respirável proporciona um ajuste dinâmico, ideal para quem busca
              performance máxima sem abrir mão de um visual futurista e
              arrojado.
            </p>
          </div>
